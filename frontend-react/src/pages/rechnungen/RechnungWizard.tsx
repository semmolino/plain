...
export function RechnungWizard({ initialDraft, initialProjectId, initialProjectLabel, onPrefillConsumed, invoiceType = 'rechnung' }: {
  ...
  // E-Rechnungs-Felder (BT-10/13/19/83 + BT-118/120-123)
  ...
  function submitStep1() {
    ...
    patchMut.mutate({ id: draftId, body: {
      ...
      // E-Rechnungs-Felder — leere Strings als null schicken
      ...
      {step === 1 && (
        <div className="wizard-step-content">
          ...
          <div className="form-row">
            ...
            <FormField
              label="Fälligkeitsdatum" id="ridd" type="date"
          ...
          {/* E-Rechnungs-Felder (BT-10/13/19/83) — optional, einklappbar */}
          <div style={{ marginTop: 12, padding: '10px 0', borderTop: '1px solid var(--border)' }}>
            <button type="button" onClick={() => setShowEinvoice(s => !s)}
              ...
              {showEinvoice ? '▼' : '▶'} E-Rechnungs-Detailfelder (Käuferreferenz, Bestellnummer …)
            </button>
            {showEinvoice && (
              <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 10 }}>
                ...
                <div className="form-group">
                  <label htmlFor="ri-paymeans">Zahlungsart</label>
                  <select id="ri-paymeans" value={paymentMeansId} onChange={e => setPmGewaehlt(e.target.value)}
                ...
                <div className="form-group">
                  ...
                  <p style={{ fontSize: 11, color: 'var(--text-3)', margin: '4px 0 0 0' }}>
                    Bei "Reverse Charge §13b UStG" (z.B. Bauleistung an Bauträger) wird kein Steuerbetrag ausgewiesen
                    und der Standardhinweis automatisch ergänzt.
                  </p>
                </div>
                {vatCategory !== 'S' && (
                  <>
                ...
                <p style={{ fontSize: 11, color: 'var(--text-3)', margin: 0 }}>
                  Optional. Bei öffentlichen Auftraggebern ist die Leitweg-ID erforderlich — wird vom Empfänger im Format geprüft.
                </p>
              </div>
            )}
          </div>
