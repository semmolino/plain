...
CREATE VIEW "REPORTING"."VW_REPORT_PROJECT_DETAIL_STRUCTURE" AS
 SELECT ps."TENANT_ID",
  ...
  GROUP BY ps."TENANT_ID", ps."PROJECT_ID", ps."ID", ps."FATHER_ID", ps."ABBR", ps."NAME", ppl."REVENUE_COMPLETION", ppl."EXTRAS_COMPLETION";
...
CREATE VIEW "public"."VW_REPORT_PROJECT_DETAIL_STRUCTURE" AS
 SELECT ps."TENANT_ID",
   ...
   FROM "PROJECT_STRUCTURE" ps
     LEFT JOIN "BOOKING" t ON t."TENANT_ID" = ps."TENANT_ID" AND t."STRUCTURE_ID" = ps."ID"
  GROUP BY ps."TENANT_ID", ps."PROJECT_ID", ps."ID", ps."FATHER_ID", ps."ABBR", ps."NAME", ps."BILLING_TYPE_ID", ps."REVENUE", ps."EXTRAS", ps."REVENUE_COMPLETION", ps."EXTRAS_COMPLETION", ps."REVENUE_COMPLETION_PERCENT";
