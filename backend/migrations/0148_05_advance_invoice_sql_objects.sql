...
CREATE VIEW "REPORTING"."VW_PROJECT_BILLING_AGG" AS
 SELECT p."TENANT_ID",
    p."ID" AS "PROJECT_ID",
    COALESCE(pp_agg."PARTIAL_PAYMENT_NET_TOTAL", 0::numeric) AS "PARTIAL_PAYMENT_NET_TOTAL",
   ...
   FROM "PROJECT" p
     LEFT JOIN ( SELECT "ADVANCE_INVOICE"."TENANT_ID",
            ...
            sum(COALESCE("ADVANCE_INVOICE"."TOTAL_AMOUNT_NET", 0::numeric)) AS "PARTIAL_PAYMENT_NET_TOTAL"
...
CREATE VIEW "public"."VW_REPORT_PROJECT_DETAIL" AS
 SELECT p."TENANT_ID",
    ...
    COALESCE(p."ADVANCE_INVOICED", 0::numeric) AS "PARTIAL_PAYMENT_NET_TOTAL",
