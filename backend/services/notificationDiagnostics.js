  ...
  for (let i = 0; i < 62; i++) {
    ...
    if (i === 0) {
      ...
      if (schedule.hasReachedTimeOfDay(cfg.SCHEDULE_TIME_OF_DAY, tag)) {
        ...
        return { datum: dateStr, uhrzeit: (cfg.SCHEDULE_TIME_OF_DAY || "").slice(0, 5) || null, faellig: true };
      }
    }
    return {
      datum:   dateStr,
