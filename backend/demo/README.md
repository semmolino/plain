...
| `seed/`               | **Bewegungsdaten-Generator**: erzeugt mehrjährigen Verlauf (Buchungen, Leistungsstände, Abschlagsrechnungen + Zahlungen, Abwesenheiten; Schlussrechnung folgt) auf Basis der manuell angelegten Stammdaten, über die echten Services. Siehe [`seed/README.md`](./seed/README.md) | 🟡 Buchungen, Leistungsstände, Abschläge+Zahlungen, HR |
