...
| `seed/`               | **Bewegungsdaten-Generator**: erzeugt mehrjährigen Verlauf (Buchungen, Leistungsstände, Abschlags- + Schlussrechnungen, Zahlungen, Abwesenheiten) auf Basis der manuell angelegten Stammdaten, über die echten Services. Siehe [`seed/README.md`](./seed/README.md) | ✅ alle Domänen (bookings, progress, invoicing, hr) |
