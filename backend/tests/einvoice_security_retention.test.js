...
function abschlag({ seAmount = SE } = {}) {
  return makeFakeSupabase(Object.assign({}, stammdaten, {
    ...
    PROJECT_STRUCTURE: [{ ID: 500, TENANT_ID: TENANT, ABBR: "LPH 1-4", NAME_LONG: "Abschlag", BILLING_TYPE_ID: 1 }],
...
function schlussrechnung({ seAmount = SE } = {}) {
  return makeFakeSupabase(Object.assign({}, stammdaten, {
    ...
    PROJECT_STRUCTURE: [{ ID: 500, TENANT_ID: TENANT, ABBR: "LPH 1-9", NAME_LONG: "Gesamt", BILLING_TYPE_ID: 1 }],
    INVOICE_DEDUCTION: [
